...
public class Activity_searchxzfw extends BaseActivity {
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		context = Activity_searchxzfw.this;
		...
		db = DbUtils.create(Activity_searchxzfw.this, Common.DB_NAME);
		setDialog();
		setAdapter();
	...
	private void setAdapter() {
		// TODO Auto-generated method stub
		try {
			adapter = new MdmAdapter(Activity_searchxzfw.this,list,"0");
			...
			listView.setOnItemClickListener(new AdapterView.OnItemClickListener() {
				...
				public void onItemClick(AdapterView<?> adapterView, View view, int i, long l) {
					...
					if(!TextUtils.isEmpty(calledNum)){
						Intent intent = new Intent(Activity_searchxzfw.this,MdmContactDetailActivity.class);
						intent.putExtra("orgNode",orgNode);
						startActivity(intent);
					}else{
						Toast.makeText(Activity_searchxzfw.this, "该站点暂无号码", Toast.LENGTH_SHORT).show();
					}
