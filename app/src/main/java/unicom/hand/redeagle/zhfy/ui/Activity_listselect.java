...
public class Activity_listselect extends BaseActivity {
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		context = Activity_listselect.this;
		list = new ArrayList<>();
		...
		iv_search.setOnClickListener(new OnClickListener() {
			...
			public void onClick(View arg0) {
				// TODO Auto-generated method stub
				Intent intent = new Intent(context, Activity_searchSelect.class);
	...
	private void setAdapter() {
		...
		try {
			...
			adapter = new MdmAdapter(Activity_listselect.this,
					list,isadd);
...
//					sp.password = "901089";
	...
	private void initSpDate() {
		// TODO Auto-generated method stub
		db = DbUtils.create(Activity_listselect.this, Common.DB_NAME);
		try {
	...
	private void setSpinnerDate(String[] strings, Spinner sp) {
		...
		ArrayAdapter<String> adapter = new ArrayAdapter<String>(
				Activity_listselect.this, android.R.layout.simple_spinner_item,
				strings);
		// 设置样式
