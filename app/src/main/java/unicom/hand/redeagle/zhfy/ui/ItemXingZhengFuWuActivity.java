...
public class ItemXingZhengFuWuActivity extends AppCompatActivity {
...
//    private String code;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        db = DbUtils.create(ItemXingZhengFuWuActivity.this, Common.DB_NAME);
...
//                    Log.e("aaa",myCityBean2.getName()+"在上面");
    ...
    public void initTab(final String name, final String nodeId,final MyCityBean2 myCityBean2){
        ...
        index++;
        View inflate1 = View.inflate(ItemXingZhengFuWuActivity.this, R.layout.item_top_link, null);
...
//            }
        ...
        public View getView(final int i, View convertView, ViewGroup viewGroup) {
            ...
            if (convertView == null) {
                convertView = LayoutInflater.from(ItemXingZhengFuWuActivity.this).inflate(R.layout.item_lv_child1lj_redeagle,null);
...
//        CheckBox cb_agree;
    ...
    private void setDialog() {
        ...
        ll_status = (LinearLayout) LayoutInflater.from(ItemXingZhengFuWuActivity.this).inflate(R.layout.ad_threetree_status, null);
        statusText = (TextView) ll_status.findViewById(tv_status);
        builder = new AlertDialog.Builder(ItemXingZhengFuWuActivity.this, R.style.Base_Theme_AppCompat_Dialog);
    ...
    class MyLvAdapter1 extends BaseAdapter {
        ...
        public View getView(final int i, View convertView, ViewGroup viewGroup) {
           final ViewHolder1 groupViewHolder;
            if (convertView == null) {
                convertView = LayoutInflater.from(ItemXingZhengFuWuActivity.this).inflate(R.layout.item_lv_child1lj_xzfw,null);
        ...
        if (sp.state == AccountConstant.STATE_UNKNOWN) {
            ...
            if (ad != null && ad.isShowing()) {
                new Handler().postDelayed(new Runnable() {
                    ...
                    public void run() {
                        ad.dismiss();
                        YealinkApi.instance().call(ItemXingZhengFuWuActivity.this, callId);
                    }
                },2000);
            }
