...
public class SelectXzfwActivity extends BaseActivity {
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		setContentView(R.layout.activity_selectxzfw);
		...
		iv_right.setOnClickListener(new OnClickListener() {
			...
			@Override
			public void onClick(View arg0) {
				Intent intent = new Intent(SelectXzfwActivity.this,Activity_searchSelect.class);
		...
		adapter1 = new GridView1Adapter(SelectXzfwActivity.this, beans1);
		adapter2 = new GridView2Adapter(SelectXzfwActivity.this, beans2);
...
//				getDate();
				...
				if (!beans2.get(arg2).getIsLongBoolean()) {
					for (ItemBean itemBean : tempdata) {
						if (itemBean.getName().equals(
								beans2.get(arg2).getName())) {
							if (!itemBean.getCode().equals("")) {
								tempdata.remove(itemBean);
								break;
							}else {
		...
		gridView1.setOnItemClickListener(new OnItemClickListener() {
			...
			public void onItemClick(AdapterView<?> arg0, View arg1, int arg2,
				...
				if (adapter1.getItem(arg2).getName().equals("县乡村")) {
					intent = new Intent(SelectXzfwActivity.this,
							SelectItemXingZhengFuWuActivity.class);
					...
					intent.putExtra("isadd", "1");
					startActivity(intent);
				}else if (adapter1.getItem(arg2).getName().equals("教育咨询")) {
					adapter1.getItem(arg2).setIsAdd(true);
					intent = new Intent(SelectXzfwActivity.this,
							SelectItemXingZhengFuWuActivity.class);
					intent.putExtra("item", adapter1.getItem(arg2));
