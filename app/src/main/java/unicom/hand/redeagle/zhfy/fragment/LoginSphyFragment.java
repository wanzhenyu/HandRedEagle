 ...
 */
public class LoginSphyFragment extends Fragment {
    ...
    private onTestListener mainActivity;
    public LoginSphyFragment() {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        return inflater.inflate(R.layout.fragment_login_sphy, container, false);
    }
...
//                            "pds01.com", "202.110.98.2");
    ...
    protected void onAttachToContext(Context context) {
        //do something
        mainActivity = (onTestListener)context;
    }
    ...
    private void updateStatus(int status){
        if (status == AccountConstant.STATE_UNKNOWN) {
            ...
            if(mainActivity != null){
                mainActivity.onShowIndex();
                AppApplication.isLogion = true;
                if(!this.isAdded()){
                    Log.e("aaa","没有提那1几道");
                }
//                Intent intent = new Intent(UIUtils.getContext(), SphyMainActivity.class);
//                startActivity(intent);
            }
