 ...
 * 
 */
public class ImageTxtIndicatorView extends RelativeLayout {
	/**
	 * ViewPager控件
	 */
	 ...
	 * 指示器对应的文本标题
	 */
	private TextView indicatoer_tv ;
	...
	public ImageTxtIndicatorView(Context context, AttributeSet attrs, int defStyle) {
		super(context, attrs,defStyle);
		this.init(context);
	}
	public ImageTxtIndicatorView(Context context, AttributeSet attrs) {
		super(context, attrs);
		this.init(context);
	}
	public ImageTxtIndicatorView(Context context) {
		super(context);
		this.init(context);
	}
	...
	private void init(Context context) {
		LayoutInflater.from(context).inflate(R.layout.image_txt_indicator_layout, this);
		this.viewPager = (ViewPager) findViewById(R.id.view_pager);
		this.indicateLayout = (LinearLayout) findViewById(R.id.indicater_layout);
		this.leftButton = (Button) findViewById(R.id.left_button);
		this.rightButton = (Button) findViewById(R.id.right_button);
		this.indicatoer_tv = (TextView) findViewById(R.id.indicatoer_tv);
		...
		this.refreshHandler = new ScrollIndicateHandler(ImageTxtIndicatorView.this);
	}
	...
	public void addViewTxt(String txt){
	...
	public void show() {
		...
		final android.widget.LinearLayout.LayoutParams params = (android.widget.LinearLayout.LayoutParams) indicateLayout.getLayoutParams();
		...
		indicatoer_tv.setText(txtList.get(currentIndex));
	}
	...
	private static class ScrollIndicateHandler extends Handler {
		private final WeakReference<ImageTxtIndicatorView> scrollIndicateViewRef;

		public ScrollIndicateHandler(ImageTxtIndicatorView scrollIndicateView) {
			this.scrollIndicateViewRef = new WeakReference<ImageTxtIndicatorView>(
					scrollIndicateView);
		...
		public void handleMessage(Message msg) {
			...
			ImageTxtIndicatorView scrollIndicateView = scrollIndicateViewRef.get();
